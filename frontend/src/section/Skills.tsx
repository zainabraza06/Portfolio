...
export const skillGroups: SkillGroup[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'MCP', note: 'Model Context Protocol — one tool layer serving web, WhatsApp and Instagram.' },
      { name: 'LLM Tool Calling', note: 'Mistral and Claude driving real actions behind explicit confirmation.' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'WhatsApp & Instagram APIs', note: 'Cloud API and Messaging webhooks with HMAC signature validation.' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Jest', note: 'Backend integration tests, including concurrency checks.' },
